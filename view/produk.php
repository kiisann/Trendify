...
<div class="row">
<?php
// Data diambil dari variabel $data_produk yang dikirim Controller
    ...
    <div class="col-md-3">
        <div class="card mb-4 shadow-sm border-0">
            <div class="card-body text-center">
                ...
                <p style="color: var(--primary-color); font-weight: 600;">Rp <?= number_format($row['harga'], 0, ',', '.'); ?></p>
...
<h3 class="fw-bold text-uppercase mb-4" style="letter-spacing: 2px;">Rekomendasi Produk</h3>
